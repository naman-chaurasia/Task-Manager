        ...
        <div className="w-full max-w-2xl mx-auto bg-gray-900 rounded-2xl shadow-xl border border-gray-800 p-4 sm:p-8 md:p-12">
          ...
          <div className="divide-y divide-gray-800">
            ...
            <div className="py-4 sm:py-6">
              ...
              <p className="text-gray-300 text-sm sm:text-base">If you have any questions about privacy, contact us at <a href="mailto:naman.chaurasia0311@gmail.com" className="text-blue-400 underline">naman.chaurasia0311@gmail.com</a>.</p>
            </div>
          </div>
